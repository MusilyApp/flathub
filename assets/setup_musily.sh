...
ls -l $projectName/data/flutter_assets/assets/icons/musily_tray/
cp $projectName/data/flutter_assets/assets/icons/tray/tray_icon.png /app/share/icons/hicolor/32x32/apps/musily_tray_icon.png
